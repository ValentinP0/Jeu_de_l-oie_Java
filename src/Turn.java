public class Turn {
    ...
    public void firstChangeCell(){
        ...
        if ((sum==9)&&((Dice1==6)||(Dice2==6))){
            System.out.println(player.getName()+"a fait un 9 avec 6 et 3");
            player.setBoardCell(26);
            displayDestinationCell(26);
        }
        else if ((sum==9)&&((Dice1==4)||(Dice2==5))){
            System.out.println(player.getName()+"a fait un 9 avec 4 et 5");
            player.setBoardCell(53);
            displayDestinationCell(53);
        }
        else if (sum==6){
            System.out.println(player.getName()+"a fait un premier jet égal à 6");
